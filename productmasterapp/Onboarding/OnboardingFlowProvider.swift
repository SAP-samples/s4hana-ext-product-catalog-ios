...
// productmasterapp
//
// Created by SAP Cloud Platform SDK for iOS Assistant application on 01/10/19
//
...
public class OnboardingFlowProvider: OnboardingFlowProviding {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: ServiceConfiguration.getScpAppId(), authenticationPath: ServiceConfiguration.getScpDestinationName())
        ...
        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            ...
            welcomeStepUI.detailLabel.text = NSLocalizedString("keyWelcomeScreenMessage", value: "This application demonstrates the \nextensibility of SAP S/4HANA Cloud", comment: "XMSG: Message on WelcomeScreen")
