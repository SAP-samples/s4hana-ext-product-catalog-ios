// TODO: Change to com.sap.bp.productmasterapp

//
// OnboardingManager.swift
// displayProducts
//
// Created by SAP Cloud Platform SDK for iOS Assistant application on 21/01/19
//
...
class OnboardingManager {
    ...
    private let authPath = ServiceConfiguration.getMobileDestinationId()
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        ...
        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            ...
            welcomeStepUI.detailLabel.text = NSLocalizedString("keyWelcomeScreenMessage",
                                                               value: "This application demonstrates the \nextensibility of SAP S/4HANA Cloud",
